...
if args.dynlensmass:
    ...
    assert LA
    LA.deltat_mu(CPUs, sim_dir, sim_phy, sim_name, hf_name, lc_dir, HQ_dir)

elif args.histogramoflenses == 'redshift':
    assert LA
    LA.histogram_lens('Halo_z', CPUs, sim_dir, sim_phy, sim_name, hf_name, lc_dir, HQ_dir)

elif args.histogramoflenses == 'mass':
    assert LA
    LA.histogram_lens('M200', CPUs, sim_dir, sim_phy, sim_name, hf_name, lc_dir, HQ_dir)
    ...
    assert LA
    LA.histogram_src('mu', CPUs, sim_dir, sim_phy, sim_name, hf_name, lc_dir, HQ_dir)
